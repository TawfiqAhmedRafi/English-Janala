...
const displayLevelWord =(words)=>{
   ...
   words.forEach(word => {
    ...
    <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
        ...
        <div class="font-bangla font-semibold text-2xl">
...
btnDiv.innerHTML=`
            <button id="lesson-btn-${lesson.level_no}" onclick="loadLevelWord(${lesson.level_no})" class="btn btn-outline btn-primary lesson-btn"><i class="fa-solid fa-book"></i></i>Lesson -${lesson.level_no}
            </button>
`;
